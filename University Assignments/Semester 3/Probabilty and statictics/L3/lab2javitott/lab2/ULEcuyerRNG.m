...
% Description
% -----------
% The function generates continuous uniform pseudorandom numbers on the interval \left(0,1\right).
% Its implementation is based on the article
%
% P. L'Ecuyer, 1986. Efficient and portable 32-bit random variate generators. 
...
% Implementation of the combined multiplicative linear congruential generator [L'Ecuyer, 1986] 
% for \mathcal{U}\left(\left(0,1\right)\right) random sampling:
