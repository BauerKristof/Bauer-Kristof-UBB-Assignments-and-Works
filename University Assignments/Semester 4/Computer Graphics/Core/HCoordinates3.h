...
namespace cagd
{
    ...
    inline GLfloat
    HCoordinate3::x() const
    {
      return _data[0];
    }

    inline GLfloat
    HCoordinate3::y() const
    {
      return _data[1];
    }

    inline GLfloat
    HCoordinate3::z() const
    {
      return _data[2];
    }

    inline GLfloat
    HCoordinate3::w() const
    {
      return _data[3];
    }
    ...
    HCoordinate3::operator+=(const HCoordinate3& rhs)
    {
        GLfloat new_x = rhs.w() * x() + w() * rhs.x(); //TODO:temporalis nelkul
        GLfloat new_y = rhs.w() * y() + w() * rhs.y();
        GLfloat new_z = rhs.w() * z() + w() * rhs.z();
        GLfloat new_w = w() * rhs.w();
    ...
    {
      return HCoordinate3(
        rhs.x() * lhs, rhs.y() * lhs, rhs.z() * lhs, rhs.w());
    }

    // homework: dot product
    inline GLfloat HCoordinate3::operator*(const HCoordinate3& rhs) const
    {
      return (_data[0] * rhs.x() + _data[1] * rhs.y() + _data[2] * rhs.z()) /
             _data[3] * rhs.w();
    }
    ...
    HCoordinate3::operator^=(const HCoordinate3& rhs)
    {
      GLfloat x = _data[1] * rhs.z() - _data[2] * rhs.y();
      GLfloat y = rhs.x() * _data[2] - rhs.z() * _data[0];
    ...
    // homework: divide with scalar
    inline const HCoordinate3
    HCoordinate3::operator/(GLfloat rhs) const
    {
    ...
    inline std::ostream&
    operator<<(std::ostream& lhs, const HCoordinate3& rhs)
    {
    ...
    inline std::istream&
    operator>>(std::istream& lhs, HCoordinate3& rhs)
    {
      lhs >> rhs.x() >> rhs.y() >> rhs.z() >> rhs.w();
      return lhs;
    }
