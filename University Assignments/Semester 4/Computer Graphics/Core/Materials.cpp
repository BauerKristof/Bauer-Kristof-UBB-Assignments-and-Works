...
Material::Material(const Color4& front_ambient,
...
GLvoid
Material::SetAmbientColor(GLenum face, const Color4& c)
{
  switch (face) {
    case GL_FRONT:
      _front_ambient = c;
...
GLvoid
Material::SetAmbientColor(GLenum face,
                          GLfloat r,
                          GLfloat g,
                          GLfloat b,
                          GLfloat a)
...
// homework
GLvoid
Material::SetDiffuseColor(GLenum face, const Color4& c)
{
...
GLvoid
Material::SetDiffuseColor(GLenum face,
                          GLfloat r,
                          GLfloat g,
                          GLfloat b,
                          GLfloat a)
...
GLvoid
Material::SetSpecularColor(GLenum face, const Color4& c)
{
...
GLvoid
Material::SetSpecularColor(GLenum face,
                           GLfloat r,
                           GLfloat g,
                           GLfloat b,
                           GLfloat a)
...
GLvoid
Material::SetEmissiveColor(GLenum face, const Color4& c)
{
...
GLvoid
Material::SetEmissiveColor(GLenum face,
                           GLfloat r,
                           GLfloat g,
                           GLfloat b,
                           GLfloat a)
...
// homework
GLvoid
Material::SetShininess(GLenum face, GLfloat shininess)
{
  switch (face) {
    case GL_FRONT:
...
// homework
GLvoid
Material::SetTransparency(GLfloat alpha)
{
  // GL_FRONT
...
{
  // GL_FRONT
  if (_front_ambient.a() == 1)
    return GL_TRUE;
  if (_front_diffuse.a() == 1)
    return GL_TRUE;
  if (_front_emissive.a() == 1)
    return GL_TRUE;
  if (_front_specular.a() == 1)
    return GL_TRUE;

  // GL_BACK
  if (_back_ambient.a() == 1)
    return GL_TRUE;
  if (_back_diffuse.a() == 1)
    return GL_TRUE;
  if (_back_emissive.a() == 1)
    return GL_TRUE;
  if (_back_specular.a() == 1)
    return GL_TRUE;
