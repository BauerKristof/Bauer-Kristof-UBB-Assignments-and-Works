...
inline GLfloat
TCoordinate4::s() const
{
  return _data[0];
}
inline GLfloat
TCoordinate4::t() const
{
  return _data[1];
}
inline GLfloat
TCoordinate4::r() const
{
  return _data[2];
}
inline GLfloat
TCoordinate4::q() const
{
  return _data[3];
}
...
inline std::ostream&
operator<<(std::ostream& lhs, const TCoordinate4& rhs)
{
...
inline std::istream&
operator>>(std::istream& lhs, TCoordinate4& rhs)
{
  return lhs >> rhs.s() >> rhs.t() >> rhs.r() >> rhs.q();
}
}
